...
case class TopDeal(cards: List[Card]) extends Message
case class CallingTrump(caller: Int) extends Message
case class Trump(trump: Suit) extends Message
case class BottomDownDeal(cards: List[Card]) extends Message
case class BottomUpDeal(cards: List[Card]) extends Message
